...
![Logo](new.png)
***
**_A command line program for creating synthetic observations of galaxies from [Illustris](http://www.illustris-project.org/).
Create mock observations from Hubble Space Telescope or Sloan Digital Sky Survey._**
